...
public class SME extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_m_e);
        ...
        Cursor cursor = db.query(TABLENAME,null,"school=?",new String[]{"SME"},null,null,null,null); // 数据库查询
        ...
        mAdapter = new myAdapter<CommentData>(mList, SME.this, R.layout.listitem) {
            @Override
    ...
    public void onClick(View v){
        switch (v.getId()){
            case R.id.button_main_page:
                Intent button1 = new Intent(SME.this, main_page.class);
                startActivity(button1);
                break;
            case R.id.button_post_comment:
                Intent button2 = new Intent(SME.this, releaseCourseEvaluation.class);
