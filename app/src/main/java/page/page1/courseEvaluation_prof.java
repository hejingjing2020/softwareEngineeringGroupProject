...
public class courseEvaluation_prof extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course_evaluation_prof);
        ...
        mAdapter = new myAdapter<CommentData>(mList, courseEvaluation_prof.this, R.layout.listitem) {
            @Override
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                intent = new Intent(courseEvaluation_prof.this, item_info.class);
    ...
    public void onClick(View v){
        switch (v.getId()){
            ...
            case R.id.button_main_page:
                Intent button1 = new Intent(courseEvaluation_prof.this, main_page.class);
