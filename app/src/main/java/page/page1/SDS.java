...
public class SDS extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Cursor cursor = db.query(TABLENAME,null,"school=?",new String[]{"SDS"},null,null,null,null); // 数据库查询
        ...
        mAdapter = new myAdapter<CommentData>(mList, SDS.this, R.layout.listitem) {
            @Override
    ...
    public void onClick(View v){
        switch (v.getId()){
            case R.id.button_main_page:
                Intent button1 = new Intent(SDS.this, main_page.class);
                startActivity(button1);
                break;
            case R.id.button_post_comment:
                Intent button2 = new Intent(SDS.this, releaseCourseEvaluation.class);
